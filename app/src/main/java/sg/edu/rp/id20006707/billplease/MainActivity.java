package sg.edu.rp.id20006707.billplease;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amount = findViewById(R.id.editTextNumber4);
        numPax = findViewById(R.id.editTextNumber5);
        totalBill = findViewById(R.id.textView4);
        eachPays = findViewById(R.id.textView5);
        svs = findViewById(R.id.toggleButton4);
        gst = findViewById(R.id.toggleButton5);
        split = findViewById(R.id.button);
        reset = findViewById(R.id.button2);
        discount = findViewById(R.id.editTextNumber);
            ...
            public void onClick(View v) {
                if(amount.getText().toString().trim().length()!=0 && numPax.getText().toString().trim().length()!=0) {
                    ...
                    if (numPerson != 1)
                        ...
                        eachPays.setText("Each Pays: $" + newAmt + " via PayNow to 912345678");
                }
